...
* `Ctrl + A + [` → การระงับหน้าจอชั่วคราว (Freeze) เพื่อตรวจสอบข้อมูลการประมวลผลย้อนหลัง
...
```
* ขั้นตอนที่ 1 เข้าถึงเซสชันด้วยรหัสประจำตัว (ID)
```bash
screen -R id.<screen_name>
```
* ขั้นตอนที่ 2 ดำเนินการลบเซสชันเมื่อเข้าสู่ระบบสำเร็จ
```bash
Ctrl + A + K + Y
```
